  ...
  "All Client Projects": [
    {
      ...
      company_description: "IBM is a technology company that brings together all the necessary technology and services to help their clients solve their business problems. IBM integrates technology and expertise, providing infrastructure, software and consulting services for clients as they pursue the digital transformation of the world’s mission-critical businesses.",
      dev_description: "Our team helped write professional, technical articles for IBM, covering topics from Upsampling/Downsampling to K-means. There were two types of articles we worked on: informative articles explaining a conceptual topic and tutorial articles guiding readers through a coding example of a specific technique. In addition to the contents of the articles, we had to optimize our key word usage with Clearscope to help the articles perform well in the search engine results.",
