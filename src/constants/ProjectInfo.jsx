const ProjectInfo = {
  ...
  "Fall 2022": [
    {
      ...
      description:
        "Come learn all about web development! We will use HTML, CSS, and JavaScript to first teach you how to create your own website and game. Then, we will build a Google Chrome extension that blocks websites on all synced devices!",
  ...
  "Spring 2022": [
    {
      ...
      developers:
        "Michael Zhang, Justin Xu, Annie Xu, Amogh Maganahalli, Angel Mau",
      description:
    ...
    },
    {
      ...
      developers:
        "Ramya Chitturi, Pradyun Kumar, Grace Juan, Victor Zhou, Jada Klein, Laura Pei",
      description:
        "Have you ever felt scared walking home late at night but forgot to call Bear Walk? In this project, we will be building a night safety walking app for students at Berkeley. The user will enter their destination and estimated arrival time, and if the user doesn’t arrive to the location on time, then the app will notify anyone they have added to their circle. We will use React Native, JavaScript, Node.js, AWS, etc. to build the both the frontend and backend of the app! Join this project to learn how to make a ✨stunning✨ app that will keep you beary safe!",
  ...
  "Fall 2021": [
    {
      ...
      developers:
        "Lincoln Too, Erin Tsai, Eric Berndt, Joelle Siong Sin, Larissa Tsai, Rachel Xin",
      description:
        "If you want to get into machine learning and neural networks, this project is for you. During the 8-week project timeframe, we will be covering machine learning techniques like linear regression, support vector machines, and will even be building your own image classifier using a convoluted neural network! Since many of the Python libraries that involve machine learning abstract away much of the conceptual knowledge behind the models we build, we will also teach what is going on behind the code so that you will be able to build your own machine learning models in the future. The end result of our project will be a convolutional neural network that can be applied to solve a real-world problem to your liking: anything from detecting pneumonia from lungs to identifying emotions of people's faces!",
    ...
    },
    {
      ...
      leaders: "Allen Gu",
      developers:
        "Ashley Chang, Ernest Goh, Maya Zheng, Ramya Chitturi, Euhan Kim",
      description:
        "Traumatized by Flappy Bird and want revenge or just interested in game development/AI? Through this project, you’ll learn how to build games and simulations in Python, as well as how to train your computer to play them. We’ll start by developing Flappy Bird and implementing the NEAT genetic algorithm together. Then, you’ll have the chance tackle a game or problem of your own!",
  ...
  "Spring 2021": [
    ...
    },
    {
      ...
      description:
        "We're here to learn some basic C++, and then will also build a simple game engine using what we learned. The game engine will concentrate on providing basic physics principles and efficient performance. Open to new ideas, but we will begin with creating a basic bouncing ball collision animation and go from there!",
      technologies: "C++",
      imageSrc: "bounc.png",
  ...
  "Fall 2020": [
    ...
    },
    {
      ...
      description:
        "Facial Recognition On Zoom combines machine-learning based facial recognition techniques with some front-end development to build a well-rounded product that is able monitor students on zoom calls to help teachers monitor class attendance. No more fooling teachers by placing still images in front of webcams! ",
      technologies: "Python",
      imageSrc: "zoom.png",
    ...
    },
    {
      ...
      description:
        "If you're a film buff, interested in learning about the data science lifecycle, or just super passionate about Jupyter notebooks, this project is for you! We'll be working with movie datasets to go through the basics of data collection + cleaning, NLP sentiment analysis, and data modeling.",
    ...
    },
    {
      ...
      description:
        "We’re working to develop an iOS app that takes images from a user’s camera roll and simplifies them into blocks of color (a lot like vector drawings) based on contrast levels between pixels. The goal is to turn images into fun little drawings without the effort of drawing!",
  ...
  "Spring 2020": [
    {
      ...
      description:
        "Build your own personal website from scratch! We will be using HTML, CSS, and JavaScript, and no prior experience is necessary. Also learn about web design principles such as spacing, color, and typography.",
    ...
    },
    {
      ...
      description:
        "This project will start with collecting and preparing data from movie reviews. We'll do some sentiment analysis on the data and build a model that predicts whether movies will be successful or not based on their reviews.",
      technologies: "",
    ...
    },
    {
      title: "Unity RPG",
      description:
        "In this project, we're going to be building an RPG that allows the player to travel around an expansive world, fight monsters, take on quests and progress to their wildest dreams! Using the Unity Engine and C# language, taking inspiration from Maplestory and other MMORPG's, our team hopes to build an immersive experience that's going to suck you right in.",
  ...
  "All Client Projects": [
    {
      ...
      leaders: "Alyssa Smith, Angel Mau, John Glen Siy, Phillip Chen",
      developers:
        "Aditi Mundra, Alena Chao, Amogh Maganahalli, Andrew Choy, Anna Chung, Christina Yue, Esther Shen, Euhan Kim, Miller Liu, Minjune Kim, Natalie Wei, Ria Jain",
      company_description:
        "IBM is a leading provider in hybrid cloud computing, artificial intelligence, and consulting services. With a presence in over 175 countries, IBM helps clients harness the power of data insights, optimize business processes, and gain a competitive edge across industries. Its hybrid cloud platform, powered by Red Hat OpenShift, enables rapid and secure digital transformations for over 4,000 government and corporate entities. IBM’s advancements in AI, quantum computing, and industry-specific cloud solutions offer clients open and flexible options for innovation.",
      dev_description:
        "Our teams authored six technical explainers and tutorials covering a variety of machine learning concepts, including upsampling, downsampling, k-means clustering, and decision trees. These articles cater to individuals with varying levels of proficiency in machine learning, providing them with concise yet comprehensive guides to comprehend and apply these concepts effectively. See the articles here: Upsampling (technical explainer, tutorial) Downsampling (technical explainer, tutorial), K-means clustering (technical explainer), Decision Trees (tutorial)",
      technologies: "Python, Scikit-learn, Clearscope",
      imageSrc: "clients/IBM Logo.png",
    },
    {
      title: "Cozmicgo",
      ...
      developers:
        "Lauren Zheng, Larissa Tsai, Danica Tang, Alyssa Smith, Allan Chen, Sarah Keifer, Razvan Turcu",
      company_description:
        "Cozmicgo is a social media app that allows users to book and host events with their friends! Their mission is to create a social networking app where communities can gather and enjoy in-person activities. Unlike other social networking apps, activities are bookable straight from a user’s content feed. Cozmicgo believes that the best way to enjoy in-person activities are through great community and the valuable experience that happens in the journey.",
      dev_description:
        "Our team debugged functions that were used in the social networking app such as ratings, buttons, and blocking using Swift. We engineered the backend to fix the bugs and improved on the User Experience and Design. ",
      technologies: "Git, Swift",
      imageSrc: "clients/Cozmicgo Logo.png",
    },
    {
      title: "ByteKitchen",
      semester: "Spring 2023",
      leaders: "Allen Gu, Euhan Kim",
      developers:
        "Jada Klein, Kelly Yeh, Grace Juan, Lincoln Too, Justin Xu, Alex Chen",
      company_description:
        "ByteKitchen is a company that partners with local restaurants to preserve community culinary traditions. Their mission is to serve as a hub where the community can continue to enjoy their favorite local cuisines. Unlike other services that merely deliver food, they form a symbiotic partnership with these cherished establishments. Byte Kitchen believes that the best way to share and celebrate food is by preserving its authenticity and the stories it tells.",
      dev_description:
        "Our team developed a comprehensive web-based dashboard system, developed on Firebase, React, and TypeScript, paired with a user-friendly mobile application, built on React Native, designed specifically for optimizing employee scheduling and management. We meticulously engineered this system to be both robust and adaptable, ensuring it can seamlessly integrate into various business environments.",
      technologies:
        "Firebase, React, React Native, TypeScript, JavaScript, Python",
      imageSrc: "clients/Byte Kitchen Logo.png",
    },
    {
      title: "Quantcast",
      semester: "Fall 2022",
      leaders: "Allen Gu",
      developers:
        "Angel Mau, Annie Xu, Jada Klein, Kevin Chow, Rachel Xin, Tommy Hang",
      company_description:
        "Quantcast is a technology company that specializes in digital advertising and audience measurement. Their mission is to leverage big data and AI technologies to help businesses make informed decisions about their online advertising strategies. They aim to provide a deeper understanding of the audience, allowing advertisers to target their campaigns more effectively and publishers to optimize their content and user experience.",
      dev_description:
        "Our team developed a multi-process web scraper using Python framework, Scrapy, and Kafka queues to parse sites up to 10x speedup. We methodically went through and observed any bottlenecks in our scraper by developing a bare scraper to apply to final kafka partitioning and scraping. ",
      technologies: "Python",
      imageSrc: "clients/Quantcast Logo.png",
    },
    {
      title: "Kinship",
      semester: "Fall 2022",
      leaders: "Erin Tsai, Shaylan Dias",
      developers: "Larissa Tsai, Lauren Zheng, Oliver Carmont, Ramya Chitturi",
      company_description:
        "Kinship is a company that focuses on providing pet care and wellness solutions. It operates in the pet industry, offering products and services designed to enhance the health and well-being of pets. The company is known for leveraging technology and data to create innovative solutions for pet owners, and they also offer a range of products such as pet health monitoring devices, nutrition solutions, and other tools to support the overall care of animals.",
      dev_description:
        "Our team successfully implemented a booking appointment feature, allowing users to seamlessly schedule appointments for their pets. Users can now enrich their profiles by adding detailed information about their pets, facilitating a more personalized experience. We focused on expanding user engagement and functionality demonstrates a commitment to providing a comprehensive and user-friendly experience in the realm of pet care and services.",
      technologies: "React Native, Git, Jira, Confluence",
      imageSrc: "clients/Kinship Logo.png",
    },
  ],
};
